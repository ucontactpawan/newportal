...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="schedule.php" class="<?php echo ($current_page == 'schedule.php' ? 'active' : ''); ?>">Schedule</a></li>
        <li><a href="attendance_sheet.php" class="<?php echo ($current_page == 'attendance_sheet.php' ? 'active' : ''); ?>">Attendance Sheet</a></li>
        <li><a href="sheet_report.php" class="<?php echo ($current_page == 'sheet_report.php' ? 'active' : ''); ?>">Sheet Report</a></li>
